...
const Footer = () => {
  return (
    <footer className="bg-accent-foreground dark:bg-gray-800 py-12">
      <div className="container mx-auto text-center">
        ...
        <p className="mt-2 text-sm text-gray-300 dark:text-gray-400">
          © 2024 My Anime, Inc. All rights reserved.
        </p>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-300 dark:text-gray-400">
            Created & Maintained by{" "}
            <a
              target="_blank"
              className="font-semibold hover:underline text-indigo-300 hover:text-indigo-400 dark:text-indigo-400 dark:hover:text-indigo-300"
